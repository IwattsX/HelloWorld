...
- [ ] I could add a title screen on the top for better user experience
## Video Walkthrough

Here's a walkthrough of implemented features:

<img src='video_tutorials.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

<!-- Replace this with whatever GIF tool you used! -->
GIF created with ffmpeg converting from an mp4 
<!-- Recommended tools:
